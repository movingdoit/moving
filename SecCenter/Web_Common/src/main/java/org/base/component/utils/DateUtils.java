...
public class DateUtils {
	...
	public static final String Format_MonthDay = "MMdd";
	/**
...
//	private final static SimpleDateFormat DEFAULT_DATETIME_FORMATER = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	...
	public static String getCurrentMonthDay(){
		SimpleDateFormat formatter = new SimpleDateFormat(Format_MonthDay);
	...
	public static Date getFirstDAY() throws ParseException{
        ...
        Date date = new SimpleDateFormat("yyyy-MM-dd").parse(new SimpleDateFormat("yyyy-MM-dd").format(cal_1.getTime()));
        return date;
	}
	...
	public static String getNextMonthFirst(){
        ...
        cale.set(Calendar.DAY_OF_MONTH,1);//设置为1号
	...
	public static Date getNextDay() throws ParseException{
        ...
        Date date = new SimpleDateFormat("yyyy-MM-dd").parse(new SimpleDateFormat("yyyy-MM-dd").format(cale.getTime()));
        return date;
	}
	 ...
	 * @return
	 */
	public static Date getPrveDay() throws ParseException{
		Calendar cale = Calendar.getInstance();
        cale.add(Calendar.DAY_OF_MONTH, -1);
        Date date = new SimpleDateFormat("yyyy-MM-dd").parse(new SimpleDateFormat("yyyy-MM-dd").format(cale.getTime()));
        return date;
	 ...
	 * @return
	 */
	public static String getPrveDayStr() throws ParseException{
		Calendar cale = Calendar.getInstance();
        cale.add(Calendar.DAY_OF_MONTH, -1);
        return new SimpleDateFormat("yyyy-MM-dd").format(cale.getTime());
	}
	 ...
	 * @return
	 */
	public static Date getCurrentDateTimeAfter( int hour) {
		Calendar now = Calendar.getInstance();
		now.setTime(DateUtils.getCurrentDateTime());
