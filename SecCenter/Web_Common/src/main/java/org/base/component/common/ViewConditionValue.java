...
public class ViewConditionValue extends ConditionValue  implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private ViewConditionType conditionType = ViewConditionType.EQUAL;

	public ViewConditionValue() {

	}

	public ViewConditionValue(ViewConditionType viewConditionType, Object value) throws Exception {
		this.setConditionType(viewConditionType);
		this.putValue(value);
	}

	public ViewConditionType getConditionType() {
		return this.conditionType;
	}

	public void setConditionType(ViewConditionType conditionType) {
